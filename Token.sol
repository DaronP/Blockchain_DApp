...
contract PepeCoin is ERC20Interface, SafeMath {
    ...
    function balanceOf(address tokenOwner) virtual public override view returns (uint balance) {
        return balances[tokenOwner];
    }

    function allowance(address tokenOwner, address spender) virtual public override view returns (uint remaining) {
